    ...
    <div className="bg1">
      <div className="containersignin">
        <form onSubmit={onSubmit}>
          ...
          <input className="signinemailfield" type="text" placeholder="Enter Email"></input>
          <br></br>
          <br></br>
          <br></br>
          <br></br>
          <div className="signinpassword">Password:</div>
          <input className="signinemailfield" type="password" placeholder="Enter password"></input>
          <br></br>
          <br></br>
